...
#define ZVK_SHA256_SUM0(X) (ROR32(X, 2) ^ ROR32(X, 13) ^ ROR32(X, 22))

// sum1(x) = ROTR6(x) ⊕ ROTR11(x) ⊕ ROTR25(x)
#define ZVK_SHA256_SUM1(X) (ROR32(X, 6) ^ ROR32(X, 11) ^ ROR32(X, 25))

// sig0(x) = ROTR7(x) ⊕ ROTR18(x) ⊕ SHR3 (x)
#define ZVK_SHA256_SIG0(X)  (ROR32(X, 7) ^ ROR32(X, 18) ^ ((X) >> 3))

// sig1(x) = ROTR17(x) ⊕ ROTR19(x) ⊕ SHR10(x)
#define ZVK_SHA256_SIG1(X)  (ROR32(X, 17) ^ ROR32(X, 19) ^ ((X) >> 10))
...
// sum0(x) = ROTR2(x) ⊕ ROTR13(x) ⊕ ROTR22(x)
#define ZVK_SHA512_SUM0(X) (ROR64(X, 28) ^ ROR64(X, 34) ^ ROR64(X, 39))

// sum1(x) = ROTR6(x) ⊕ ROTR11(x) ⊕ ROTR25(x)
#define ZVK_SHA512_SUM1(X) (ROR64(X, 14) ^ ROR64(X, 18) ^ ROR64(X, 41))

// sig0(x) = ROTR7(x) ⊕ ROTR18(x) ⊕ SHR3 (x)
#define ZVK_SHA512_SIG0(X)  (ROR64(X, 1) ^ ROR64(X, 8) ^ ((X) >> 7))

// sig1(x) = ROTR17(x) ⊕ ROTR19(x) ⊕ SHR10(x)
#define ZVK_SHA512_SIG1(X)  (ROR64(X, 19) ^ ROR64(X, 61) ^ ((X) >> 6))
